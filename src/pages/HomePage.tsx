    ...
    <div className="bg-theater-primary min-h-screen font-sans text-theater-light">
      ...
      <div className="pt-24 px-4 sm:px-6 lg:px-8 pb-20">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-xl text-theater-muted mb-16 font-light">
            Opplev magien på scenen
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {plays.map((play) => (
              <div key={play.id} className="bg-white/5 rounded-lg overflow-hidden hover:bg-white/10 transition-colors group flex flex-col h-full">
                <div className="aspect-video bg-gray-800 relative overflow-hidden">
                  {play.content.premiere && (
                    <div className="absolute top-4 left-4 z-10">
                      <span className="bg-theater-accent text-theater-primary px-3 py-1 text-sm font-bold uppercase tracking-wider rounded shadow-lg">
